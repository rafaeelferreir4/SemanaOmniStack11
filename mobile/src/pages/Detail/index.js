...
export default function Detail () {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gosstaria de ajuda no caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR',{ style: 'currency' , currency: 'BRL' }).format(incident.value)}.`;
